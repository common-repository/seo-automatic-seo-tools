...
<tbody> 
	...
	echo '<div id="next"><form id="excel" method="post" action="'.$sc_plugin_dir.'csvexport.php"><input type="hidden" name="download" value="'.$urllisttext.'" /><input type="hidden" name="run" value="yes" /><input type="submit" value="Download CSV"></form>';
