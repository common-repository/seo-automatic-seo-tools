...
Tags: google, seo, Search Commander Inc., rss, feedcommander, url checker, link variance, keyword marriage, keyword multiplier, seo tools, search commander inc
Requires at least: 4.8.1
Tested up to: 5.8.2
Stable tag: 4.0.7

This plugin by Search Commander, Inc. contains several unique SEO tools, including an on page SEO review.

== Description ==
<a href="https://www.searchcommander.com/seo-tools-plugin/" target="_blank">Plugin Page</a> | <a href="https://wordpress.org/support/plugin/seo-automatic-seo-tools/" target="_blank">Plugin Support</a>
...
= 9. Google Cache Finder =
This tool will show you Google's cache of any URL you paste, opened in a new tab. If you get a 404 page at Google, that means there's no cache of that URL.

To use, add the shortcode: [googlecachefinder]
...
4. View the short codes listed in the Search Commander Inc. > SEO Tools menu to add the tools to pages or posts.

Installation for the URL Checker:

1. Edit your settings on the Search Commander Inc. > URL Checker admin page
...
The minimum requirement is 4.8.1 and use with any prior versions are not supported.
...
Please visit the <a href="https://wordpress.org/support/plugin/seo-automatic-seo-tools/" target="_blank">support forum</a>.
...
* Changed shortcodes to lowercase to prevent tools from not working correctly when the uppercase were copied to use.
* Updated feed in admin area.

= 4.0.3 =

* Fixed outdated code in Smarty Compiler to prevent conflicts with other scripts running on sites.

= 4.0.2 =

* Fixed unexpected characters already sent issue for url checker.

= 4.0.1 =

* Wording changes.
* Added additional function check for google cache finder tool.

= 4.0 =

* Added required image tag to Structured Data Tool.
* Add new Google Cache Finder tool.
* Fixed https issue for URL Checker.
* Add all information results for Url Checker previously only available in SEO Tools Pro.
* Updated sidebar content on admin pages.

= 3.7.7 =

* Changed hours and cleaned up results formatting in Structured Data Tool.

= 3.7.6 =

* Changed bulk url checker export from .xls to .csv for excel compatibility.
