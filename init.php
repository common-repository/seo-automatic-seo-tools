...
//	}
	...
	$smarty->assign('google_earth_enable', $settings['locale']['google_earth']['enable']);
	$smarty->assign('rel_author_enable', $settings['locale']['rel_author']['enable']);
	$smarty->assign('canonical_tag_enable', $settings['locale']['canonical_tag']['enable']);
