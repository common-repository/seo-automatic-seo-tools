...
class SEOInspector {
   ...
   */
	...
	function __construct($url, $user_agent = null) {
		...
		if ($statusCode != 200) die($statusCode.' Please enter a valid URL which is not being redirected at the server.<br /><br />'); //throw new Exception( "\"$url\" responded with HTTP status " . $website->getStatus() );
