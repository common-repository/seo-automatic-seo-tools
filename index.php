...
if ($directaccess == '/seo-automatic-seo-tools/index.php') { 
	echo '<html><head></head><body><p>This page is not meant to be directly accessed.</p><p>To try out the Search Commander Inc. URL Checker, please visit <a href="http://www.seoautomatic.com/unique-tools/instant-seo-review" rel="nofollow">here</a>.</p></body></html>';
	exit();
}
